...
public class ConnectionDao extends AbstractDao<Connection, Long> {
    ...
    public Connection readEntity(Cursor cursor, int offset) {
        Connection entity = new Connection( //
                ...
                cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // serverPort
    ...
    public static class Properties {
        ...
        public final static Property ClientId = new Property(1, String.class, "clientId", false, "CLIENT_ID");
        public final static Property ServerIp = new Property(2, String.class, "serverIp", false, "SERVER_IP");
        public final static Property ServerPort = new Property(3, String.class, "serverPort", false, "SERVER_PORT");
